...
def load_demand_zones():
    ...
    # District centroids for Istanbul's 39 districts
    district_coords = {
    'Adalar':        (29.1248, 40.8762),  # Büyükada centre
    ...
    'Beşiktaş':      (29.0089, 41.0428),
    'Beykoz':        (29.0925, 41.1244),  # inland, was in water
